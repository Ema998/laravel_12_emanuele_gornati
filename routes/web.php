...
Route::put('articoli/articoli.update/{article}', [ArticleController::class, 'update'])->name('articoli.update');
Route::delete('articoli/articoli.destroy/{article}', [ArticleController::class, 'destroy'])->name('articoli.destroy');
Route::get('articoli/articoli-create', [ArticleController::class, 'create'])->name('articoli-create');
Route::get('articoli/articoli-edit/{article}', [ArticleController::class, 'edit'])->name('articoli-edit');
Route::get('articoli/articoli-detail/{article}', [ArticleController::class, 'show'])->name('articoli-detail');
